  ...
  return (
    <>
      <section id="about" className="mb-16 scroll-mt-24">
        ...
        <div className="flex flex-col lg:flex-row text-white w-4/5 justify-center h-8/12 items-center mx-auto mt-20 lg:space-x-10 space-y-8 lg:space-y-0 ">
          <Image
            className=" flex h-90 rounded-2xl items-start"
            href="/assets/fotoMateo.JPG"
            alt="Foto Perfil Mateusz"
          />
          <TextAbout className="lg:w-6/12 h-100 flex items-center" />
        </div>
      </section>
    </>
  );

  ...
  return (
    <>
      <svg
        ...
        fill="currentColor"
      >
        <path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM.32 8.16H4.7V24H.32V8.16zM8.45 8.16h4.18v2.15h.06c.58-1.1 2-2.26 4.11-2.26 4.4 0 5.21 2.9 5.21 6.67V24h-4.38v-7.62c0-1.82-.03-4.16-2.54-4.16-2.54 0-2.93 1.98-2.93 4.03V24H8.45V8.16z" />
      </svg>
    </>
  );
}
  ...
  return (
    <>
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <path d="M5 20h14a1 1 0 0 0 0-2H5a1 1 0 1 0 0 2zm7-18a1 1 0 0 0-1 1v12.586l-3.293-3.293a1 1 0 0 0-1.414 1.414l5 5a1 1 0 0 0 1.414 0l5-5a1 1 0 0 0-1.414-1.414L13 15.586V3a1 1 0 0 0-1-1z" />
      </svg>
    </>
  );
}
